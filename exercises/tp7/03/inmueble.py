...
class Inmueble:
    ...
    def __str__(self):
        return (f"Codigo:{self.obtenerCodigo()}, Domicilio:{self.obtenerDomicilio()}, Metros Cuadrados: {self.obtenerMCuadrados()}, Estado{self.obtenerEstado()}, Propieterio: {self.obtenerPropietario}")